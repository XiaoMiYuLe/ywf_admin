...
class Api_Bts_Order_Groupon
{
    ...
    public static function run ($params = null)
    {
        ...
        if ($res['status'] == 0) {
            ...
            /* 生成订单 */
            $res = Bts_Model_Order::instance()->grouponaction($res['data']['sku'], $res['data']['userid'], $res['data']['buy_num'], $res['data']['consignee'], $res['data']['order_type']);
        }
