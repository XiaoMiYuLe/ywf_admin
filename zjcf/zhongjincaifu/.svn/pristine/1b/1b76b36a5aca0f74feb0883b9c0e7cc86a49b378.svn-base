...
class Groupon_Model_Bulk extends Zeed_Db_Model
{
    /**
     * @var string The table name.
     */
    protected $_name = 'bulk';
    ...
    public function fetchByStatus($status , $order, $count = null, $offset = null, $cols = '*')
    {
    	...
    	$select->join('goods_content','groupon_bulk.sku = goods_content.sku',array(price_market,content_id,image_default));
