$(document).ready(function() {
    ...
    $('body').delegate('#content_listing .operate-delete', 'click', function(){
    	...
    	$.ajax({
	    	type:'post',
	        url:'/grouponadmin/category/delete',
	    ...
	    dataSource: new DataGridDataSource({
	        ...
	        formatter: function (items) {
	            $.each(items, function (index, item) {
	            	...
	            	item.operate = '<a href="/grouponadmin/category/edit/?category_id=' + item.category_id + '" data-toggle="ajaxModal" class="operate-edit" title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;' + 
