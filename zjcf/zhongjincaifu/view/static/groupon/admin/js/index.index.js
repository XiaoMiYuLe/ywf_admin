	    ...
	    dataSource: new DataGridDataSource({
	        ...
	        formatter: function (items) {
	            $.each(items, function (index, item) {
	            	...
	            	var str_operate = '<a href="/grouponadmin/index/edit/?bulk_id=' + item.bulk_id + '" class="load-content" title="编辑"><i class="fa fa-pencil"></i></a>';
