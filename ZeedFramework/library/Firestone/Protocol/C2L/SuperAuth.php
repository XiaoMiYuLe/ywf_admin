<?php
/**
 * Firestone_Protocol_C2L_SuperAuth
 * 
 * @package Firestone_Protocol_C2L
 * @since 2010-8-30
 * @author yaojie
 * 超级密码控制
 */

class Firestone_Protocol_C2L_SuperAuth extends Firestone_Protocol_QMEProtocolSendAbstract
{
    
    const DATA_FORMAT = "a33";
    
    protected $_data = array(
            'password' => '');
    
    /**
     * @return Firestone_Protocol_C2L_SuperAuth
     */
    ...
    {
        $this->_dataPackString = pack(self::DATA_FORMAT, $this->_data['password']);
        return $this;
    }
