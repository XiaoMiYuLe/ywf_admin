<?php 
/**
 * Firestone_Protocol_C2S_GivePresent 
 * 
 ...
 */
 ...
 class Firestone_Protocol_C2S_GivePresent extends Firestone_Protocol_QMEProtocolSendAbstract
 {
    const DATA_FORMAT = 'a51a51Va20';
    
    protected $_data = array('username'=>'','description'=>'','presentID'=>0,'expireTime'=>'');
    /**
     * @return Firestone_Protocol_C2S_GivePresent 
     */
    ...
    {
        $this->_dataPackString = pack(self::DATA_FORMAT, $this->_data['username'], $this->_data['description'], $this->_data['presentID'], $this->_data['expireTime']);
        return $this;
    }
