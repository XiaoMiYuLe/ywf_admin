 ...
 * 火石协议 编码 386
 * 
 * Firestone_Protocol_C2S_AccountInfo
 * 
 * @package    Firestone_Protocol_
 * @since      2010-8-31
 * @author     wida<wida@foxmail.com>
 */
class Firestone_Protocol_C2S_AccountInfo extends Firestone_Protocol_QMEProtocolSendAbstract
{
    ...
    protected $_data = array(
            'name' => '');
    /**
     * @return Firestone_Protocol_C2S_AccountInfo
     */
