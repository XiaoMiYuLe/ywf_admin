<?php
/**
 * Firestone_Protocol_C2S_CharInquiry
 * 
 * @package    Firestone_Protocol_C2S
 * @since      2010-9-1
 * @author       wida<wida@foxmail.com>
 */
class Firestone_Protocol_C2S_CharInquiry extends Firestone_Protocol_QMEProtocolSendAbstract
{
    ...
    protected $_data = array(
            'keyword' => '');
    /**
     * @return Firestone_Protocol_C2S_CharInquiry
     */
