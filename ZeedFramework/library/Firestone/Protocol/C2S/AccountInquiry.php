 ...
 * 
 * 
 * Firestone_Protocol_C2S_AccountInquiry
 * @package    Firestone_Protocol_C2S
 * @since      2010-8-31
 * @author     wida<wida@foxmail.com>
 */
class Firestone_Protocol_C2S_AccountInquiry extends Firestone_Protocol_QMEProtocolSendAbstract
{
    ...
    protected $_data = array(
            'keyword' => '');
    /**
     * @return Firestone_Protocol_C2S_AccountInquiry
     */
