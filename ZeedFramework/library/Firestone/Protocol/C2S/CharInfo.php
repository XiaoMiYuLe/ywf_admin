<?php
/**
 * Firestone_Protocol_C2S_CharInfo
 * 
 * @package    Firestone_Protocol_C2S
 * @since      2010-9-1
 * @author       wida<wida@foxmail.com>
 */
class Firestone_Protocol_C2S_CharInfo extends Firestone_Protocol_QMEProtocolSendAbstract
{
    ...
    protected $_data = array(
            'rolename' => '');
    /**
     * @return Firestone_Protocol_C2S_CharInfo
     */
    ...
    {
        $this->_dataPackString = pack(self::DATA_FORMAT, $this->_data['rolename']);
        return $this;
    }
