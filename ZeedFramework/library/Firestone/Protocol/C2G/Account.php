<?php
/**
 * Firestone_Protocol_C2G_Account
 * 
...
class Firestone_Protocol_C2G_Account extends Firestone_Protocol_QMEProtocolSendAbstract
{
    
    const DATA_FORMAT = "a51";
    
    protected $_data = array('name' => '');
    
    /**
     * @return Firestone_Protocol_C2G_Account
     */
