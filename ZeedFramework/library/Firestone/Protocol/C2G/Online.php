...
class Firestone_Protocol_C2G_Online extends Firestone_Protocol_QMEProtocolSendAbstract
{
    ...
    /**
     * @return Firestone_Protocol_C2G_Online
     */
